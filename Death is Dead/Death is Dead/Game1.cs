...
namespace Death_is_Dead
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        GameMain main;
        SoundEffect sound_buttons_click;
        ...
        /* Menu*/    // screen stuff
            ...
            btnPlay = new cButton(Content.Load<Texture2D>("sprite/Buttons/English/Button_play"), graphics.GraphicsDevice);
            btnPlay.setPosition(new Vector2(600, 100));
            sound_buttons_click = (Content.Load<SoundEffect>("Sound_menu/button_sound"));
       ...
       /*menu*/     MouseState mouse = Mouse.GetState();
            switch (CurrentGameState)
            {
                case GameState.MainMenu:
                    if (btnPlay.isClicked) sound_buttons_click.Play();
